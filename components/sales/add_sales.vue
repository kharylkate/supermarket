...
<hr>
              ...
              <div class="card">
                ...
                <ul>
                  ...
                  <div class="form-row d-flex col-md-12 mt-0 mb-0">
                    <div class="form-group col-md-3">
                    ...
                    <div class='form-group col-md-1'>
                      <button class="btn btn-danger rem_item text-white" type="button" @click="removeElement" id="Action">Remove</button>
                    </div>
                  </div>
                </li>
                </ul>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary text-white" id="salescancel" data-dismiss="modal">Cancel</button>
              <button type="button" @click="saveSales()" class="btn btn-primary text-white">OK</button>
            </div>
