          ...
          <form action="" id="add_supplier_form">
            <div class="form-row justify-content-center">
              ...
              <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control" id="compname" placeholder="Enter Company Name" autocomplete="off" required>
              </div>

              <div class="form-group col-md-8">
                <label for="contactno">Contact Number: </label>
                <input type="number" class="form-control" id="contactno" placeholder="Enter Contact Number" autocomplete="off" required>
              </div>

              <div class="form-group col-md-8">
                <label for="compadd">Company Address: </label>
                <input type="text" class="form-control" id="compadd" placeholder="Enter Company Address" autocomplete="off" required>
              </div>
